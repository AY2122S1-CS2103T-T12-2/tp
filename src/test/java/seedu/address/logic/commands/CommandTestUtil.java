...
public class CommandTestUtil {
    ...
    public static final String VALID_REVIEW_AMY = "Great";
    public static final String VALID_REVIEW_BOB = "Bad";
    ...
    static {
        DESC_AMY = new EditContactDescriptorBuilder().withCategoryCode(VALID_CATEGORY_CODE_ATT).withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).withRating(VALID_RATING_AMY).withReview(VALID_REVIEW_AMY).build();
        DESC_BOB = new EditContactDescriptorBuilder().withCategoryCode(VALID_CATEGORY_CODE_OTH).withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).withRating(VALID_RATING_BOB)
                .withReview(VALID_REVIEW_BOB).build();
    }
